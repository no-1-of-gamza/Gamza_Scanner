...
def multi_threading(num_threads,thread_ids,target_host,ports):
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=num_threads) as executor:
        ...
        for future in concurrent.futures.as_completed(futures):
            ...
            print( f"Thread ID: {thread_id} has finished scanning port {port}.")
...
def result_printing(thread_ids,closed_ports,open_ports):
    ...
    closed_ports.sort()  # Sort the closed ports list
    open_ports.sort()    # Sort the open ports list
